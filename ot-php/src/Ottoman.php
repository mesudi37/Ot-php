 ...
 *
 * ----------------------------------------------------------------------
 * Class Name: PHP and Ottoman Language
 *
 * This project inspired and produced from Mr. Khaled Al-Sham'aa ' s 
 * great project Ar-php to apply the code for Ottoman Turkish Language 
 * Please see The main project : http://www.ar-php.org
 * Original    Author(s): Mesut Sezer and Khaled Al-Sham'aa <khaled@ar-php.org>
 *
 * Purpose:    Set of PHP classes developed to enhance Ottoman web
 *             applications by providing set of tools includes
 *             translitiration and more...
 * Test Page : https://cevir.teknikvideo.net/
 */
...
class Ottoman
{
    ...
    {
        $json = json_decode((string)file_get_contents($this->rootDirectory . '/data/ot_transliteration.json'), true);
     ...
     * @author Khaled Al-Sham'aa <khaled@ar-php.org>
     */
    public function tr2ot($string, $locale = 'tr_TR.UTF-8')
    {
        setlocale(LC_ALL, $locale);

        $string = transliterator_create("tr-Lower")->transliterate($string);
    ...
    public function fixKeyboardLang($str)
    {
        ...
        $capital = 'ABCÇDEFGĞHIİJKLMNOÖPQRSŞTUÜVWXYZabcçdefgğhıijklmnoöpqrsştuüvwxyz';
        $small   = 'abcçdefgğhıijklmnoöpqrsştuüvwxyzABCÇDEFGĞHIİJKLMNOÖPQRSŞTUÜVWXYZ';
